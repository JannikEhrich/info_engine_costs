...
%
% author:  JEhrich
% version: 1.3 (2022-04-28)
% changes: moved control phase to [k ts, k ts + tau], renamed "feedback"
% "control", adjusted annotations to compensate
clear
close all
clc
...
annotation('textbox','Position',[0.1495,0.6, 0.1, 0.1],'String','$V_\mathrm{r}(x,z), \nu_\mathrm{low}$',...
    'Interpreter','latex','FontSize',fS,'HorizontalAlignment','center',...
    'VerticalAlignment','middle','Linestyle','none','color','r');
...
annotation('textbox','Position',[0.3075,0.45,0.0,0.1],'String','$V_\mathrm{c}(x,z;t), \nu_\mathrm{high}$',...
    'Interpreter','latex','FontSize',fS,'HorizontalAlignment','center',...
    'VerticalAlignment','middle','Linestyle','none','color','b');
